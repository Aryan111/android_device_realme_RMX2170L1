...
DEVICE_PATH := device/realme/RMX2170L1
...
# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := RMX2170,RMX2170L1,ossi,qssi,atoll
...
TARGET_KERNEL_CONFIG := RMX2170L1_defconfig
TARGET_KERNEL_SOURCE := kernel/realme/RMX2170L1
...
BOARD_BOOTIMAGE_PARTITION_SIZE := 42897408
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 42897408
